...
namespace SagePayMvc.Tests {
	public class StubUrlResolver : IUrlResolver {
		...
		public const string SuccessUrl = "http://stub/success";
		public const string FailUrl = "http://stub/failed";
		public const string NotificationUrl = "http://stub/notification";
	}
}