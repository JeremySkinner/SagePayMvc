...
namespace SagePayMvc {
	...
	public static class UrlResolver {
		static Func<IUrlResolver> urlResolver = () => new DefaultUrlResolver();

		public static void Initialize(Func<IUrlResolver> resolver) {
			if (resolver == null) resolver = () => new DefaultUrlResolver();
		...
		/// </summary>
		public static IUrlResolver Current {
			get { return urlResolver(); }
		}
	}
}